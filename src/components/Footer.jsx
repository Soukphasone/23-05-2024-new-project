        ...
        <div className="bg-wrapper w-full flex">
          ...
          >
            ...
            <defs>
              ...
              >
                <stop stopColor="var(--footer)"></stop>
                <stop offset="1" stopColor="var(--balance-wrapper2)"></stop>
              </linearGradient>
                  ...
                  <div>
                    <span className="nuxt-icon text-[23px]">
                      <svg
                        ...
                        xmlns="http://www.w3.org/2000/svg"
                      >
                        <g clipPath="url(#clip0_6112_3315)">
                          <path
                  ...
                  <div>
                    <span className="nuxt-icon text-[var(--primary)] gradientText text-[23px]">
                      <svg
                        ...
                        xmlns="http://www.w3.org/2000/svg"
                      >
                        <g clipPath="url(#clip0_6112_2946)">
                          <path
                      ...
                      >
                        ...
                        <defs>
                          <linearGradient
                            ...
                            gradientUnits="userSpaceOnUse"
                          >
                            <stop stopColor="#FFD15C"></stop>
                            <stop offset="0.5" stopColor="#F6DB96"></stop>
                            <stop offset="1" stopColor="#9B7A24"></stop>
                          </linearGradient>
                        </defs>
                      </svg>
                    </span>
