...
function Footer({depositBankList}) {
  const history = useHistory();
  const NextoBank = () => {
    history.push(Constant.DEPOSIT_WITHDRAW, depositBankList)
  };
      ...
      >
        ...
        <div className="navigate-wrapper">
          <div className="navigate-container md:max-w-[630px] base-container-small">
            <a
              onClick={NextToHome}
              className="router-link-active router-link-exact-active item md:w-full"
              aria-current="page"
            >
              <div>
            ...
            <div className="item" onClick={NextoPromotion}>
              <a className="">
                <div>
            ...
            >
              <div className="item" >
                ...
                <span className="text-[12px]">ฝาก/ถอน</span>
              </div>
            </a>
            <div className="item" onClick={NextoBag}>
              <a className="">
                <div>
                  <span className="nuxt-icon text-[23px]">
                    <svg
            ...
            <div className="item">
              <div className="">
                <a href="https://line.me/R/ti/p/@799uzxcy" className="">
